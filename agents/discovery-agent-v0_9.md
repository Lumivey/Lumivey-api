...
| **Aanleiding** | Vijf simulaties (hovenier, diabetespedicure, stichting, sceptische ondernemer, snackbarhouder) tonen drie herkenningsfouten: vragen naar logisch onmogelijke/reeds-bekende informatie, gemiste signaalreflectie, ontbrekende signaalprioriteit |
| **Type correctie** | Gericht — optimalisatie volgens LW05 (Herkenning Eerst). Geen herontwerp. Architectuur, doel, Signals Framework, Preview Threshold, Governance, Wetten en Kompas ongewijzigd. |
...
| **2. SOLL voldoende concreet** | De gewenste richting is voldoende beschreven voor een herkenbare eerste Preview-stap. "Google-vindbaar zijn" is voldoende. "Iets anders" is niet voldoende. | Ondernemer heeft een richting benoemd die zonder aanvullende vragen vertaald kan worden naar een eerste stap. |
...
- Locatie: Rotterdam
- SOLL: Google-vindbaar, praktijkinformatie, over mezelf, afsprakensysteem, contactgegevens
...
> Spiegel: "Als ik het goed begrijp start je binnenkort als diabetespedicure in Rotterdam onder de naam ProVoet, en wil je een website die klanten laat boeken en meer over jou vertelt. Klopt dat?"
> Ondernemer: "Ja, precies!"

LP34-evaluatie:
- IST bevestigd: ja (starter, geen website) ✅
- SOLL concreet: ja (vindbaar, info, afspraken, contact) ✅
...
## 1D. Logische uitsluiting van vragen (nieuw in v0.9)
...
*(Ongewijzigd t.o.v. v0.7 — zie v0.7 sectie 5 voor volledige beschrijving)*

De spiegeldrempel is bereikt wanneer minimaal twee van drie criteria waar zijn: A (2+ IST-elementen), B (1+ SOLL-richting), C (uitnodigingssignaal). Bij drempel bereikt: spiegelen vóór nieuwe vraag.
...
- Naam: ProVoet
- Locatie: Rotterdam
- SOLL: Google-vindbaar, praktijkinfo, over mij, afsprakensysteem, contact
- Spiegel bevestigd: "Ja, precies!"

**LP34-evaluatie:**
- IST bevestigd: ✅ (starter, geen website)
- SOLL concreet: ✅ (vindbaar, info, afspraken, contact)
